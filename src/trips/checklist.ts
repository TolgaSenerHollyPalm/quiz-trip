...
const BY_KIND: Partial<Record<TripKind, Suggestion[]>> = {
  ...
  fun: [
    pack('fun-tickets', 'Park ve otel rezervasyonunun çevrimdışı kopyası'),
    pack('fun-shoes', 'Bütün gün yürünecek rahat ayakkabı'),
    pack('fun-spare-clothes', 'Yedek kıyafet (ıslanan oyunlar için)'),
    pack('fun-rain', 'İnce yağmurluk'),
    pack('fun-water', 'Su matarası'),
    pack('fun-coins', 'Dolap ve oyunlar için bozuk para'),
    todo('fun-hours', 'Park ve gösteri saatlerine bak'),
    todo('fun-app', 'Parkın uygulamasını/haritasını indir'),
    todo('fun-meeting-point', 'Kaybolunca buluşulacak yeri kararlaştır'),
  ],
  winter: [
